...
public interface CourseRepository extends CrudRepository<CourseEntity, String> {
	...
	CourseEntity findByCourseIdAndDeletedIsFalse(String courseId);
	...
	Optional<CourseEntity> findByUserIdAndCourseIdAndDeletedIsFalse(String userId, String courseId);
}
